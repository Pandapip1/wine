...
C_ASSERT( offsetof(struct set_job_limits_request, active_process_limit) == 20 );
C_ASSERT( offsetof(struct set_job_limits_request, process_memory_limit) == 24 );
C_ASSERT( offsetof(struct set_job_limits_request, process_time_limit) == 32 );
C_ASSERT( sizeof(struct set_job_limits_request) == 40 );
...
C_ASSERT( offsetof(struct get_job_info_reply, active_process_limit) == 20 );
C_ASSERT( offsetof(struct get_job_info_reply, process_memory_limit) == 24 );
C_ASSERT( offsetof(struct get_job_info_reply, process_time_limit) == 32 );
C_ASSERT( sizeof(struct get_job_info_reply) == 40 );
